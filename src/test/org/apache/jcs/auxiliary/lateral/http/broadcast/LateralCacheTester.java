...
public class LateralCacheTester
{
    ...
    public static void main( String args[] )
    {
        ...
        try
        {
            ...
            LateralCacheThread dct = new LateralCacheThread( "testTable", "testkey", val, servers );
            dct.setPriority( Thread.NORM_PRIORITY - 1 );
            dct.start();

            String val2 = "test object value2";
            LateralCacheThread dct2 = new LateralCacheThread( "testTable", "testkey", val, servers );
