 ...
 */
public class TestHSQLDiskCache
    extends TestCase
{
    /**
     ...
     * @param testName
     */
    public TestHSQLDiskCache( String testName )
    {
        super( testName );
    }
    ...
    {
        String[] testCaseName = { TestHSQLDiskCache.class.getName() };
    ...
    public static Test suite()
    {
        ...
        suite.addTest( new TestHSQLDiskCache( "testHSQLDsikCache1" )
        {
            public void runTest()
                throws Exception
            {
...
/*
        suite.addTest( new TestHSQLDiskCache( "testHSQLDsikCache2" )
        {
            public void runTest()
                throws Exception
            {
        ...
        suite.addTest( new TestHSQLDiskCache( "testHSQLDsikCache3" )
        {
            public void runTest()
                throws Exception
            {
