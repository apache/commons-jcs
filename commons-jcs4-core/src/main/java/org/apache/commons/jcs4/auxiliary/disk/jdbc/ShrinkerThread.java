    ...
    implements Runnable
{
     ...
     * of regions.
     *
     * @param pauseBetweenRegionCalls The pauseBetweenRegionCalls to set.
     */
    public void setPauseBetweenRegionCallsMillis(final Duration pauseBetweenRegionCalls )
    {
        this.pauseBetweenRegionCalls = pauseBetweenRegionCalls;
    }
}
