    ...
    implements ICacheAccess<K, V>
{
    ...
    {
        return getCacheControl().get( name );
    }
    ...
    {
        return getCacheControl().getMultiple( names );
    }
    ...
    public IElementAttributes getElementAttributes( final K name ) throws CacheException
    {
        ...
        try
        {
            attr = getCacheControl().getElementAttributes( name );
        }
    ...
    public Map<K, V> getMatching( final String pattern )
    {
        ...
        final Map<K, ICacheElement<K, V>> wrappedResults = getCacheControl().getMatching( pattern );
    ...
    {
        return getCacheControl().getMatching( pattern );
    }
    ...
    public void put( final K name, final V obj )
    {
        ...
        put( name, obj, getCacheControl().getElementAttributes() );
    }
     ...
     *
     * @see org.apache.commons.jcs4.access.behavior.ICacheAccess#put(Object, Object, IElementAttributes)
     */
    @Override
