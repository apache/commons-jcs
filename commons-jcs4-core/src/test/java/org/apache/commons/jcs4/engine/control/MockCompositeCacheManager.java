    ...
    implements ICompositeCacheManager
{
    ...
    /**
	 * @see org.apache.commons.jcs4.engine.behavior.IShutdownObservable#deregisterShutdownObserver(org.apache.commons.jcs4.engine.behavior.IShutdownObserver)
	 */
	@Override
...
//            System.out.println( "Creating mock cache" );
            final CompositeCache<K, V> newCache =
                new CompositeCache<>( CompositeCacheAttributes.defaults(), new ElementAttributes() );
            setCache( newCache );
        }
    ...
    /**
	 * @see org.apache.commons.jcs4.engine.behavior.IShutdownObservable#registerShutdownObserver(org.apache.commons.jcs4.engine.behavior.IShutdownObserver)
	 */
	@Override
