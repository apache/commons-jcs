...
public class MakeJCacheCDIInterceptorFriendly implements Extension
{
    ...
    private static final boolean USE_ID = !Boolean.getBoolean("org.apache.commons.jcs4.cdi.skip-id");
                                               ...
                                               final BeanManager bm)
    {
        ...
        <beans xmlns="http://java.sun.com/xml/ns/javaee"
          ...
          <interceptors>
            <class>org.apache.commons.jcs4.jcache.cdi.CacheResultInterceptor</class>
            <class>org.apache.commons.jcs4.jcache.cdi.CacheRemoveAllInterceptor</class>
            <class>org.apache.commons.jcs4.jcache.cdi.CacheRemoveInterceptor</class>
            <class>org.apache.commons.jcs4.jcache.cdi.CachePutInterceptor</class>
          </interceptors>
        </beans>
         */
